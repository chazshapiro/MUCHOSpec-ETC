...
from rubin_sim.skybrightness import SkyModel  ### adds 1s to import
...
sky_model = SkyModel(observatory=Site(name='LSST',**obs_loc) ,airmass_limit=sky_airmass_limit)  ### adds 4.9s
